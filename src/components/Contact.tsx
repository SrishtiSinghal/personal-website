              ...
              <motion.div key={link.label} variants={fadeInUp}>
                {link.href ? (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-xl bg-[var(--card)] border shadow-sm hover:shadow-md hover:border-clay-500/30 transition-all duration-300 group"
                  >
                    <div className="w-12 h-12 rounded-lg bg-clay-500/10 flex items-center justify-center group-hover:bg-clay-500/20 transition-colors">
                      <link.icon
                        size={20}
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold group-hover:text-clay-600 dark:group-hover:text-clay-400 transition-colors">
                        {link.value}
                      </p>
                    </div>
                  </a>
